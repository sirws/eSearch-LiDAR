  ...
  function(declare,
    ...
    return declare([_WidgetBase, Evented], {
      ...
      add: function(item) {
        ...
        if(item.showRelate){
          var relImg = domConstruct.toDom("<a href='javascript:void(0);' target='_blank' title='" + item.relalias + "'><img src='" + this.parentWidget.folderUrl + "images/i_relate.png' alt='" + item.relalias + "' border='0' width='20px' height='20px'></a>");
          domConstruct.place(relImg, linksDiv);
          domClass.add(relImg, 'linkIcon');
          domAttr.set(relImg, "id", this.id.toLowerCase()+item.id);
          this.own(on(relImg, 'click', lang.hitch(this, this._onRelate)));
        }
      ...
      _onRelate: function(evt) {
        ...
        this._selectedNode = id;
        this.emit('relate', this.selectedIndex, item);
      },
